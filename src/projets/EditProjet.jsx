...
export default function EditProjet({
  ...
  function handleSubmit(e) {
    ...
    const date_debut = new Date(project.date_debut);
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2">
              <div className="col-span-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setProject({ ...project, intitule: e.target.value })
                  }
                />
              </div>
              ...
              <div className="col-span-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setProject({ ...project, date_debut: e.target.value })
                  }
                />
              </div>
              {project?.date_fin && (
                <div className="col-span-1">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setProject({ ...project, date_fin: e.target.value })
                    }
                  />
                </div>
              )}
              ...
              <div className="col-span-1">
                ...
                <input
                  ...
                  value={project?.duree}
                  onChange={(e) =>
                    setProject({ ...project, duree: Number(e.target.value) })
                  }
                />
              </div>
            </div>
